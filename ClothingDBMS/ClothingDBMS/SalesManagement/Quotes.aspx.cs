    ...
    public partial class Quotes : System.Web.UI.Page
    {
       protected void Page_Load(object sender, EventArgs e)
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SqlDataSourceQuotation.InsertParameters["QOquantity"].DefaultValue = Quantity.Text;
            SqlDataSourceQuotation.InsertParameters["Product_Id"].DefaultValue = dropProductId.SelectedValue;
            SqlDataSourceQuotation.InsertParameters["Quotation_Number"].DefaultValue = dropQotationNum.SelectedValue;
