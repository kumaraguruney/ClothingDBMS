<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shipment.aspx.cs" Inherits="ClothingDBMS.SalesManagement.Shipment" %>
        ...
        <asp:Panel ID="panelSaveSalesOrder" Visible="true" runat="server" >
            <asp:GridView ID="GridViewSalesOrder" runat="server" AutoGenerateColumns="False" DataKeyNames="Quotation_Number" DataSourceID="SqlDataSourceSalesOrder" AllowSorting="True" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="InvUpdate" ShowHeader="False">
                               <ItemTemplate>
                                    <asp:LinkButton ID="lnkUpdateInv" runat="server" OnClick="btnUpdateInv_Click" Text="InvUpdate"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Ships" ShowHeader="False">
                               <ItemTemplate>
                                    <asp:LinkButton ID="lnkShip" runat="server" OnClick="btnUpdateShip_Click" Text="DoShipment"></asp:LinkButton>
                                </ItemTemplate>
                             </asp:TemplateField>
