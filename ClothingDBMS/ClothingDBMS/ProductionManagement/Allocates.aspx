...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:clothingDBMSConnectionString %>" SelectCommand="SELECT Employee_ID, Employee_Name, Address, Contact_Number, Date_of_Birth FROM Employee ORDER BY Employee_Name"></asp:SqlDataSource>
